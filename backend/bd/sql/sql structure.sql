...
CREATE TABLE HISTORIAL_RESERVAS (
	...
	ID_RESERVA VARCHAR(16) NOT NULL REFERENCES RESERVAS(ID_RESERVA) ON DELETE CASCADE,
...
CREATE TABLE MOVIMIENTOS_REACTIVOS (
	...
	ID_REACTIVO VARCHAR(17) NOT NULL REFERENCES REACTIVOS(ID_REACTIVO) ON DELETE CASCADE,
...
CREATE TABLE MOVIMIENTOS_CRISTALERIA (
	ID_MOVIMIENTO VARCHAR(17) PRIMARY KEY,
	ID_CRISTALERIA VARCHAR(16) NOT NULL REFERENCES CRISTALERIA(ID_CRISTALERIA) ON DELETE CASCADE,
